...
/* Need to mention the addresses relative to BAR-1 */
...
/* 
 * Increase MAP_SIZE to accomodate all addresses : bit size of final address and initial address
 *  MAP_MASK just masks the lower 16 bits for MAP_SIZE address here
*/
