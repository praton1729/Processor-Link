...
silent only
cd ~/Documents/Sem-9/DDP/Codes/Driver_Codes/Processor_Link_AXI
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 src/processor_link.c
badd +0 src/processor_link_internal.c
badd +0 include/processor_link.h
badd +0 include/processor_link_internal.h
badd +0 include/hardware_description.h
argglobal
silent! argdel *
argadd src/processor_link.c
set stal=2
edit src/processor_link.c
...
1
normal! 0
tabedit include/processor_link.h
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
1
normal! 0
tabedit src/processor_link_internal.c
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
1
normal! 0
tabedit include/processor_link_internal.h
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
1
normal! 0
tabedit include/hardware_description.h
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
